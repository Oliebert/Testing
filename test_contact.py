...
class test_contact(unittest.TestCase):
    ...
    def test_contact(self):
        ...
        self.create_contact(wd, firstname_of_contact="nknnn", middlename_of_contact="khknkhn", lastname_of_contact="khknkhn", contactnickname="kbjb",
    ...
    def test_empty_contact(self):
        ...
        self.open_contact_page(wd)
        self.create_contact(wd, firstname_of_contact="", middlename_of_contact="",
    ...
    def create_contact(self, wd, firstname_of_contact, middlename_of_contact, lastname_of_contact, contactnickname,
                       contacttittle, contactcompany, contactaddress, homenumber, mobilenumber, worknumber,
                       contact_email, contact_fax, contact_notes, contact_email2, contact_email3, contact_homepage,
                       contact_address2, contact_phone2):
        wd.find_element_by_name("firstname").click()
        wd.find_element_by_name("firstname").clear()
        wd.find_element_by_name("firstname").send_keys(firstname_of_contact)
        wd.find_element_by_name("middlename").click()
        wd.find_element_by_name("middlename").clear()
        wd.find_element_by_name("middlename").send_keys(middlename_of_contact)
        wd.find_element_by_name("lastname").click()
        wd.find_element_by_name("lastname").clear()
        wd.find_element_by_name("lastname").send_keys(lastname_of_contact)
        wd.find_element_by_name("nickname").click()
        wd.find_element_by_name("nickname").clear()
        wd.find_element_by_name("nickname").send_keys(contactnickname)
        wd.find_element_by_name("title").click()
        wd.find_element_by_name("title").clear()
        wd.find_element_by_name("title").send_keys(contacttittle)
        ...
        wd.find_element_by_name("address2").send_keys(contact_address2)
        wd.find_element_by_name("phone2").click()
        wd.find_element_by_name("phone2").clear()
        wd.find_element_by_name("phone2").send_keys(contact_phone2)
        wd.find_element_by_name("notes").click()
        wd.find_element_by_name("notes").clear()
        wd.find_element_by_name("notes").send_keys(contact_notes)
