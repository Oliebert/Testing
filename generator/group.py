...
'''geopts это библиотека, которая помогает проанализировать строку, которая содержит набор опций, то есть имеет характерный формат
откуда вы эту строку получили -- неважно. обычно это действительно опции, переданные из командной строки. но источник может быть и другим. например, можно прочитать строку с опциями из файла
'''
